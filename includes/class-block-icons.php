...
class Block_Icons {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-block-icons-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-block-icons-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-block-icons-admin.php';

		/**
		 * The class is responsible for defining all actions related to notifications.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/notices.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'public/class-block-icons-public.php';
	...
	private function define_admin_notices() {
		...
		$this->loader->add_action( 'admin_init', $plugin_admin, 'disable_admin_notices_on_specific_pages', 99999999 );
